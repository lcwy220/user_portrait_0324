...
WEIBO_USER_INDEX_NAME = 'weibo_user'
WEIBO_USER_INDEX_TYPE = 'user'
...
def all_sort_filter( time = 1 , sort_norm = 'bci' , sort_scope = 'all_nolimit' , arg = None):
    ...
    if sort_norm == 'bci':
        ...
        return es_get_userlist_by_all('fansnum')
    elif sort_norm == 'weibo_count':
        return es_get_userlist_by_all('statusnum')
