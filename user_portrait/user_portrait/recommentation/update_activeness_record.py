...
from user_portrait.global_utils import COPY_USER_PORTRAIT_INFLUENCE as copy_portrait_index_name
from user_portrait.global_utils import COPY_USER_PORTRAIT_INFLUENCE_TYPE as copy_portrait_index_type
